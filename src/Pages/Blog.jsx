...
class Blog extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      const blogPostContent = await fetch(apiUrl+'/blogposts?slug='+this.returnApiSlugURL(), {
        method: 'GET',
        headers: headers,
      })
    .then(checkStatus)
      ...
      <div className="medium-col">
        ...
        <div className="Card-container">
          {         
            ...
            <Link to={this.formatLink("/blog?slug=",posts.slug)} key={posts.id} onClick={this.handleArticleClick.bind()}>
              <Card 
                title={posts.title}
